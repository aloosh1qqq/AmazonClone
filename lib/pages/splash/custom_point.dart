...
class CoustmIndecator extends StatefulWidget {
  @override
  _CoustmIndecatorState createState() => _CoustmIndecatorState();
}

class _CoustmIndecatorState extends State<CoustmIndecator>
...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    Paint myArc = Paint()
      ..color = AppColors.textColor //Color(0xff00A2FF)
